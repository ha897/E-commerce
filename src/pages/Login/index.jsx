            ...
            <div className='container'>
                <div className='card shadow-md w-[400px] m-auto rounded-md bg-white p-5 px-10'>
                    ...
                    <form className="w-full mt-5">
                        ...
                        <Link className="link cursor-pointer text-[14px] font-[600]">
                            Forgot Password?
                        </Link>
                        ...
                        <div>
                            <div className="flex items-center justify-center gap-4 flex-col">
                                <p>Not Registered? <Link className="link text-primary cursor-pointer text-[14px] font-[600]" to="/register">Sign Up</Link></p>
